...
To use your own custom network checks, implement the [NetworkStatus](https://github.com/aerogear/offix/blob/0.13.0/packages/offix-offline/src/network/NetworkStatus.ts)
