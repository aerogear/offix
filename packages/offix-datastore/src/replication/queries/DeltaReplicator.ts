import { DeltaQueriesConfig, ModelDeltaConfig } from "../api/ReplicationConfig";
import { NetworkStatusEvent, NetworkStatus } from '../../network/NetworkStatus';
import { ModelPredicate, PredicateExpression, PredicateFunction, ModelFieldPredicate } from "../../predicates";
...
export class DeltaReplicator {
  ...
  public start() {
    ...
    // Only when online
    if (this.options.networkInterface.isOnline()) {
